...
window.source.json = {
  nodes: [
    ...
    {
      id:
        "Discovery of Type II Inhibitors of TGFÎ²-Activated Kinase 1 (TAK1) and Mitogen-Activated Protein Kinase Kinase Kinase Kinase 2 (MAP4K2)",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "An unexpected twist to the activation of IKKÎ²: TAK1 primes IKKÎ² for activation by autophosphorylation",
      group: "Cited Works",
      radius: 2,
      citing_patents_count: 2,
    },
    ...
    {
      id:
        "3-(2-oxoethylidene)indolin-2-one derivatives activate Nrf2 and inhibit NF-ÎºB: potential candidates for chemoprevention.",
      group: "Cited Works",
      radius: 6,
    ...
    {
      id:
        "Dysregulation of ubiquitin homeostasis and Î²-catenin signaling promote spinal muscular atrophy",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    {
      id:
        "Structure-Guided Design and Optimization of Small Molecules Targeting the ProteinâProtein Interaction between the von HippelâLindau (VHL) E3 Ubiquitin Ligase and the Hypoxia Inducible Factor (HIF) Alpha Subunit with in Vitro Nanomolar Affinities",
      group: "Cited Works",
      radius: 2,
      citing_patents_count: 2,
    },
    ...
    {
      id:
        "Investigation of acyclic uridine amide and 5â²-amido nucleoside analogues as potential inhibitors of the Plasmodium falciparum dUTPase",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "A novel shogaol analog suppresses cancer cell invasion and inflammation, and displays cytoprotective effects through modulation of NF-ÎºB and Nrf2-Keap1 signaling pathways",
      group: "Cited Works",
      radius: 2,
      citing_patents_count: 2,
    },
    ...
    {
      id:
        "Acinetobacter baumannii FolD ligand complexes â potent inhibitors of folate metabolism and a reâevaluation of the structure of LY374571",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "Design, Synthesis, and StructureâActivity Relationship Exploration of 1-Substituted 4-Aroyl-3-hydroxy-5-phenyl-1H-pyrrol-2(5H)-one Analogues as Inhibitors of the Annexin A2âS100A10 Protein Interaction",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    {
      id:
        "4-benzimidazolyl-3-phenylbutanoic acids as novel PIF-pocket-targeting allosteric inhibitors of protein kinase PKCÎ¶.",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "SCF/Î²-TrCP promotes glycogen synthase kinase 3-dependent degradation of the Nrf2 transcription factor in a keap1-independent manner",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "Polyubiquitin binding to optineurin is required for optimal activation of TANK-binding kinase 1 and production of interferon Î².",
      group: "Cited Works",
      radius: 2,
      citing_patents_count: 2,
    },
    ...
    {
      id: "The cytoprotective role of the Keap1âNrf2 pathway",
      group: "Cited Works",
      radius: 7,
      citing_patents_count: 7,
    },
    ...
    {
      id:
        "NF-ÎºB controls energy homeostasis and metabolic adaptation by upregulating mitochondrial respiration",
      group: "Cited Works",
      radius: 1,
      citing_patents_count: 1,
    },
    ...
    {
      id:
        "The specificities of small molecule inhibitors of the TGFÃ and BMP pathways",
      group: "Cited Works",
      radius: 3,
      citing_patents_count: 3,
    },
    ...
    {
      id:
        "AMP-activated protein kinaseâan energy sensor that regulates all aspects of cell function",
      group: "Cited Works",
      radius: 7,
      citing_patents_count: 7,
    },
  ...
  links: [
    ...
    {
      source: "The cytoprotective role of the Keap1âNrf2 pathway",
