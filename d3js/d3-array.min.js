...
!(function (t, n) {
  ...
  function g(t, n, r) {
    ...
    for (
      var e = -1, o = 0 | Math.max(0, Math.ceil((n - t) / r)), f = new Array(o);
      ++e < o;
  ...
  function x(t, n, r) {
    var e = (n - t) / Math.max(0, r),
      ...
      f = e / Math.pow(10, o)
    return o >= 0
      ? (f >= y ? 10 : f >= m ? 5 : f >= A ? 2 : 1) * Math.pow(10, o)
      : -Math.pow(10, -o) / (f >= y ? 10 : f >= m ? 5 : f >= A ? 2 : 1)
  }
  function w(t, n, r) {
  ...
  function N() {
    ...
    function e(e) {
      ...
      var a = n(l),
        ...
        h = r(l, c, s)
      Array.isArray(h) ||
        ((h = w(c, s, h)), (h = g(Math.ceil(c / h) * h, s, h)))
      for (var d = h.length; h[0] <= c; ) h.shift(), --d
      for (; h[d - 1] > s; ) h.pop(), --d
      var v,
        M = new Array(d + 1)
      for (f = 0; f <= d; ++f)
        ((v = M[f] = []).x0 = f > 0 ? h[f - 1] : c), (v.x1 = f < d ? h[f] : s)
      for (f = 0; f < i; ++f)
        c <= (u = l[f]) && u <= s && M[o(h, u, 0, d)].push(e[f])
      return M
    }
    return (
      (e.value = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : p(n)), e)
          : t
      }),
      (e.domain = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : p([t[0], t[1]])), e)
          : n
      }),
    ...
    for (; o > e; ) {
      if (o - e > 600) {
        const n = o - e + 1,
          ...
          a = 0.5 * Math.sqrt((i * l * (n - l)) / n) * (u - n / 2 < 0 ? -1 : 1)
        k(
          t,
          r,
          Math.max(e, Math.floor(r - (u * l) / n + a)),
          Math.min(o, Math.floor(r + ((n - u) * l) / n + a)),
          f
        )
      }
      const n = t[r]
  ...
  function z(t) {
    ...
    for (var n = -1, r = I(t, D), e = new Array(r); ++n < r; )
