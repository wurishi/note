...
!(function (t, n) {
  ...
  function M() {
    ...
    return (
      ...
      (c.x1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : 'function' == typeof t ? t : i(+t)), c)
          : e;
      }),
      (c.y = function (t) {
        return arguments.length
      ...
      (c.y1 = function (t) {
        return arguments.length
          ? ((h = null == t ? null : 'function' == typeof t ? t : i(+t)), c)
          : h;
      }),
  ...
  (at.prototype = {
    ...
    (ut.prototype = {
      ...
      lineEnd: function () {
        ...
        if (i > 0)
          for (
            var e, s = t[0], h = n[0], o = t[i] - s, _ = n[i] - h, r = -1;
            ++r <= i;
  ...
  function Pt(t, n, i) {
    var e = t._x1 - t._x0,
      ...
      _ = (h * s + o * e) / (e + s);
    return (
      (At(h) + At(o)) * Math.min(Math.abs(h), Math.abs(o), 0.5 * Math.abs(_)) ||
      0
    );
  }
  function Ct(t, n) {
  ...
  function Yt(t) {
    var n,
      ...
      h = new Array(e),
      o = new Array(e);
    for (s[0] = 0, h[0] = 2, o[0] = t[0] + 2 * t[1], n = 1; n < e - 1; ++n)
  ...
  (Et.prototype = {
      ...
      lineEnd: function () {
        ...
        if (i)
          if (
            ...
            for (var e = Yt(t), s = Yt(n), h = 0, o = 1; o < i; ++h, ++o)
    ...
    (t.arc = function () {
      ...
      function S() {
        var i,
          ...
          E = T > d;
        if (
          (M || (M = i = n.path()), v < p && ((y = v), (v = p), (p = y)), v > c)
        )
          if (S > f - c)
            M.moveTo(v * h(d), v * r(d)),
              M.arc(0, 0, v, d, T, !E),
              p > c && (M.moveTo(p * h(T), p * r(T)), M.arc(0, 0, p, T, d, E));
          else {
            var A,
              P,
              C = d,
            ...
            X > c
              ? D > c
                ? ((A = g(U, Z, W, H, v, D, E)),
                  (P = g(K, Q, F, G, v, D, E)),
                  M.moveTo(A.cx + A.x01, A.cy + A.y01),
                  D < I
                    ? M.arc(A.cx, A.cy, D, s(A.y01, A.x01), s(P.y01, P.x01), !E)
                    : (M.arc(
                        A.cx,
                        A.cy,
                        D,
                ...
                : (M.moveTo(W, H), M.arc(0, 0, v, C, O, !E))
              : M.moveTo(W, H),
              p > c && z > c
                ? j > c
                  ? ((A = g(F, G, K, Q, p, -j, E)),
                    (P = g(W, H, U, Z, p, -j, E)),
                    M.lineTo(A.cx + A.x01, A.cy + A.y01),
                    j < I
                      ? M.arc(
                          A.cx,
                          A.cy,
      ...
      return (
        (S.centroid = function () {
          var n = (+t.apply(this, arguments) + +o.apply(this, arguments)) / 2,
            i =
              (+k.apply(this, arguments) + +m.apply(this, arguments)) / 2 -
              l / 2;
          return [h(i) * n, r(i) * n];
        }),
        ...
        (S.padRadius = function (t) {
          return arguments.length
            ? ((w = null == t ? null : 'function' == typeof t ? t : i(+t)), S)
            : w;
        }),
    ...
    (t.stack = function () {
      ...
      function h(i) {
        var h,
          ...
          c = new Array(a);
        for (h = 0; h < a; ++h) {
          for (var l, u = _[h], f = (c[h] = new Array(r)), x = 0; x < r; ++x)
      ...
      return (
        ...
        (h.order = function (t) {
          return arguments.length
            ? ((n = null == t ? jt : 'function' == typeof t ? t : i(X.call(t))),
              h)
            : n;
        }),
        (h.offset = function (t) {
    ...
    (t.stackOffsetDiverging = function (t, n) {
      if ((_ = t.length) > 0)
        for (var i, e, s, h, o, _, r = 0, a = t[n[0]].length; r < a; ++r)
          for (h = o = 0, i = 0; i < _; ++i)
            (s = (e = t[n[i]][r])[1] - e[0]) > 0
              ? ((e[0] = h), (e[1] = h += s))
              : s < 0
    ...
    (t.stackOrderInsideOut = function (t) {
      var n,
        ...
        a = [];
      for (n = 0; n < e; ++n)
        (i = h[n]), o < _ ? ((o += s[i]), r.push(i)) : ((_ += s[i]), a.push(i));
