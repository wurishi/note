...
!(function (t, i) {
  ...
  class n {
    ...
    update() {
      ...
      for (let i = 0; i < c; i++) {
        if (i === m || i === x) continue;
        const e = o(v, b, T, A, t[2 * i], t[2 * i + 1]);
        e < M && ((p = i), (M = e));
      }
      let k = t[2 * p],
        $ = t[2 * p + 1];
      ...
      (n[m] = e[p] = x),
        ...
        (h[p] = 2),
        r.fill(-1),
        (r[this._hashKey(v, b)] = m),
        (r[this._hashKey(T, A)] = x),
        (r[this._hashKey(k, $)] = p),
        (this.trianglesLen = 0),
        this._addTriangle(m, x, p, -1, -1, -1);
      for (let s, o, a = 0; a < this._ids.length; a++) {
        const c = this._ids[a],
          u = t[2 * c],
          _ = t[2 * c + 1];
        if (a > 0 && Math.abs(u - s) <= i && Math.abs(_ - o) <= i) continue;
        if (((s = u), (o = _), c === m || c === x || c === p)) continue;
        let f = 0;
        for (
          let t = 0, i = this._hashKey(u, _);
          t < this._hashSize &&
          (-1 === (f = r[(i + t) % this._hashSize]) || f === n[f]);
          t++
        );
        let d,
          g = (f = e[f]);
        for (
          ;
          (d = n[g]), !l(u, _, t[2 * g], t[2 * g + 1], t[2 * d], t[2 * d + 1]);
        ...
        for (
          ;
          (d = n[w]), l(u, _, t[2 * w], t[2 * w + 1], t[2 * d], t[2 * d + 1]);

        )
          (y = this._addTriangle(w, c, d, h[c], -1, h[w])),
            (h[c] = this._legalize(y + 2)),
            (n[w] = w),
            S--,
            (w = d);
        if (g === f)
          for (
            ;
            l(u, _, t[2 * (d = e[g])], t[2 * d + 1], t[2 * g], t[2 * g + 1]);

          )
            (y = this._addTriangle(d, c, g, -1, h[g], h[d])),
              this._legalize(y + 2),
              (h[d] = y),
              (n[g] = g),
              S--,
              (g = d);
        (this._hullStart = e[c] = g),
          (n[g] = e[w] = c),
          (n[c] = w),
          (r[this._hashKey(u, _)] = c),
          (r[this._hashKey(t[2 * g], t[2 * g + 1])] = g);
      }
  ...
  function l(t, i, e, n, s, l) {
    return (
      (h(s, l, t, i, e, n) || h(t, i, e, n, s, l) || h(e, n, s, l, t, i)) < 0
    );
  }
  ...
  function a(t, i, e, n) {
    if (n - e <= 20)
      ...
      (t[e + 1] = t[h]),
        (t[h] = l),
        n - s + 1 >= h - e
          ? (a(t, i, s, n), a(t, i, e, h - 1))
          : (a(t, i, e, h - 1), a(t, i, s, n));
    }
  }
  function c(t, i, e) {
    const n = t[i];
  ...
  class d {
    ...
    arc(t, i, e) {
      ...
      null === this._x1
        ? (this._ += `M${n},${s}`)
        : (Math.abs(this._x1 - n) > f || Math.abs(this._y1 - s) > f) &&
          (this._ += 'L' + n + ',' + s),
        e &&
          (this._ += `A${e},${e},0,1,1,${
            t - e
          },${i}A${e},${e},0,1,1,${(this._x1 = n)},${(this._y1 = s)}`);
    }
    rect(t, i, e, n) {
  ...
  class y {
    ...
    _init() {
      const {
          delaunay: { points: t, hull: i, triangles: e },
          vectors: n,
        } = this,
      ...
      for (let i, n, h = 0, l = 0, r = e.length; h < r; h += 3, l += 2) {
        const r = 2 * e[h],
          ...
          b = 2 * (y * p - m * x);
        if (b)
          if (Math.abs(b) < 1e-8) (i = (c + d) / 2), (n = (u + g) / 2);
          else {
            const t = 1 / b;
            (i = c + (p * w - m * v) * t), (n = u + (y * v - x * w) * t);
          }
        else (i = (c + d) / 2 - 1e8 * p), (n = (u + g) / 2 + 1e8 * x);
        (s[l] = i), (s[l + 1] = n);
      }
      let h,
        l,
    ...
    *cellPolygons() {
    ...
    _renderSegment(t, i, e, n, s) {
      let h;
      const l = this._regioncode(t, i),
        r = this._regioncode(e, n);
      0 === l && 0 === r
        ? (s.moveTo(t, i), s.lineTo(e, n))
        : (h = this._clipSegment(t, i, e, n, l, r)) &&
          (s.moveTo(h[0], h[1]), s.lineTo(h[2], h[3]));
    }
    contains(t, i, e) {
      return (
        (i = +i) == i && (e = +e) == e && this.delaunay._step(t, i, e) === t
      );
    }
    *neighbors(t) {
    ...
    _cell(t) {
      const {
          circumcenters: i,
          delaunay: { inedges: e, halfedges: n, triangles: s },
        } = this,
        h = e[t];
      if (-1 === h) return null;
      const l = [];
    ...
    _clip(t) {
      ...
      const { vectors: e } = this,
        n = 4 * t;
      return e[n] || e[n + 1]
        ? this._clipInfinite(t, i, e[n], e[n + 1], e[n + 2], e[n + 3])
        : this._clipFinite(t, i);
    }
    _clipFinite(t, i) {
      const e = i.length;
      let n,
      ...
      for (let _ = 0; _ < e; _ += 2)
        if (
          ...
          let i, e, _, f, d;
          if (0 === h) {
            if (null === (i = this._clipSegment(n, s, a, c, h, u))) continue;
            [e, _, f, d] = i;
          } else {
            if (null === (i = this._clipSegment(a, c, n, s, u, h))) continue;
            ([f, d, e, _] = i),
              (l = r),
              (r = this._edgecode(e, _)),
              l && r && this._edge(t, l, r, o, o.length),
              o ? o.push(e, _) : (o = [e, _]);
          }
          (l = r),
            (r = this._edgecode(f, d)),
            l && r && this._edge(t, l, r, o, o.length),
            o ? o.push(f, d) : (o = [f, d]);
        }
      if (o)
    ...
    _clipSegment(t, i, e, n, s, h) {
      for (;;) {
        if (0 === s && 0 === h) return [t, i, e, n];
        if (s & h) return null;
        let l,
          r,
          o = s || h;
        8 & o
          ? ((l = t + ((e - t) * (this.ymax - i)) / (n - i)), (r = this.ymax))
          : 4 & o
          ? ((l = t + ((e - t) * (this.ymin - i)) / (n - i)), (r = this.ymin))
          : 2 & o
          ? ((r = i + ((n - i) * (this.xmax - t)) / (e - t)), (l = this.xmax))
          : ((r = i + ((n - i) * (this.xmin - t)) / (e - t)), (l = this.xmin)),
          s
            ? ((t = l), (i = r), (s = this._regioncode(t, i)))
            : ((e = l), (n = r), (h = this._regioncode(e, n)));
      }
    }
    _clipInfinite(t, i, e, n, s, h) {
      let l,
        r = Array.from(i);
      if (
        ((l = this._project(r[0], r[1], e, n)) && r.unshift(l[0], l[1]),
        (l = this._project(r[r.length - 2], r[r.length - 1], s, h)) &&
          r.push(l[0], l[1]),
        (r = this._clipFinite(t, r)))
      )
        for (
          let i, e = 0, n = r.length, s = this._edgecode(r[n - 2], r[n - 1]);
          e < n;
          e += 2
        )
          (i = s),
            (s = this._edgecode(r[e], r[e + 1])),
            i && s && ((e = this._edge(t, i, s, r, e)), (n = r.length));
      else
        this.contains(
          t,
          (this.xmin + this.xmax) / 2,
    ...
    _edge(t, i, e, n, s) {
      for (; i !== e; ) {
        ...
        (n[s] === e && n[s + 1] === h) ||
          !this.contains(t, e, h) ||
          (n.splice(s, 0, e, h), (s += 2));
      }
      if (n.length > 4)
        for (let t = 0; t < n.length; t += 2) {
          const i = (t + 2) % n.length,
            e = (t + 4) % n.length;
          ((n[t] === n[i] && n[i] === n[e]) ||
            (n[t + 1] === n[i + 1] && n[i + 1] === n[e + 1])) &&
            (n.splice(i, 2), (t -= 2));
        }
      return s;
    }
    _project(t, i, e, n) {
      ...
      if (n < 0) {
        ...
        (s = (this.ymin - i) / n) < r &&
          ((l = this.ymin), (h = t + (r = s) * e));
      } else if (n > 0) {
        if (i >= this.ymax) return null;
        (s = (this.ymax - i) / n) < r &&
          ((l = this.ymax), (h = t + (r = s) * e));
      }
      if (e > 0) {
        if (t >= this.xmax) return null;
        (s = (this.xmax - t) / e) < r &&
          ((h = this.xmax), (l = i + (r = s) * n));
      } else if (e < 0) {
        if (t <= this.xmin) return null;
        (s = (this.xmin - t) / e) < r &&
          ((h = this.xmin), (l = i + (r = s) * n));
      }
      return [h, l];
    }
    _edgecode(t, i) {
  ...
  class v {
      ...
      return new v(
        'length' in t
          ? (function (t, i, e, n) {
              ...
              for (let l = 0; l < s; ++l) {
                const s = t[l];
                (h[2 * l] = i.call(n, s, l, t)),
                  (h[2 * l + 1] = e.call(n, s, l, t));
              }
              return h;
            })(t, i, e, n)
          : Float64Array.from(
    ...
    _init() {
      ...
      if (
        ...
        const t = this.collinear[0],
          ...
          s = [i[2 * t], i[2 * t + 1], i[2 * e], i[2 * e + 1]],
          h = 1e-8 * Math.sqrt((s[3] - s[1]) ** 2 + (s[2] - s[0]) ** 2);
        for (let t = 0, e = i.length / 2; t < e; ++t) {
          const e = w(i[2 * t], i[2 * t + 1], h);
      ...
      const e = (this.halfedges = this._delaunator.halfedges),
        ...
        h = (this.triangles = this._delaunator.triangles),
      ...
      for (let t = 0, i = s.length; t < i; ++t) r[s[t]] = t;
      s.length <= 2 &&
        s.length > 0 &&
    ...
    *neighbors(t) {
      ...
      if (l) {
        const i = l.indexOf(t);
        return (
          i > 0 && (yield l[i - 1]), void (i < l.length - 1 && (yield l[i + 1]))
        );
      }
      const r = i[t];
      if (-1 === r) return;
    ...
    _step(t, i, e) {
      ...
      let a = t,
        c = (i - o[2 * t]) ** 2 + (e - o[2 * t + 1]) ** 2;
      const u = n[t];
      let _ = u;
      do {
        let n = r[_];
        const u = (i - o[2 * n]) ** 2 + (e - o[2 * n + 1]) ** 2;
        if (
          (u < c && ((c = u), (a = n)),
          r[(_ = _ % 3 == 2 ? _ - 2 : _ + 1)] !== t)
        )
        ...
        if (-1 === (_ = l[_])) {
          if (
            (_ = s[(h[t] + 1) % s.length]) !== n &&
            (i - o[2 * _]) ** 2 + (e - o[2 * _ + 1]) ** 2 < c
          )
            return _;
          break;
        }
    ...
    render(t) {
      const i = null == t ? (t = new d()) : void 0,
        { points: e, halfedges: n, triangles: s } = this;
